...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new W(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`}function zl(){return{canvas:document.querySelector(`#game-canvas`),scoreElement:document.querySelector(`#score`),currentZoneElement:document.querySelector(`#current-zone`),playerLabel:document.querySelector(`#player-label`),orbsElement:document.querySelector(`#orbs`),lessonCard:document.querySelector(`#lesson-card`),quizModal:document.querySelector(`#quiz-modal`),quizZone:document.querySelector(`#quiz-zone`),quizQuestion:document.querySelector(`#quiz-question`),quizChoices:document.querySelector(`#quiz-choices`),quizFeedback:document.querySelector(`#quiz-feedback`),quizSource:document.querySelector(`#quiz-source`),continueButton:document.querySelector(`#continue-button`),winCard:document.querySelector(`#win-card`),playAgainButton:document.querySelector(`#play-again`),startScreen:document.querySelector(`#start-screen`),startGameButton:document.querySelector(`#start-game`),playerNameInput:document.querySelector(`#player-name`),audioToggle:document.querySelector(`#audio-toggle`),joystick:document.querySelector(`#joystick`),joystickKnob:document.querySelector(`#joystick-knob`),touchBrake:document.querySelector(`#touch-brake`),touchReset:document.querySelector(`#touch-reset`)}}var Bl={adab:{title:`Adab Courtyard`,color:2269291,position:new W(-11,0,-5),lesson:Ll.adab},ilmu:{title:`Ilmu Library`,color:2846442,position:new W(0,0,9),lesson:Ll.ilmu},sadaqah:{title:`Sadaqah Garden`,color:15771177,position:new W(11,0,-5),lesson:Ll.sadaqah}};function Vl(e){return e.type===`circle`&&e.radius!==void 0}function Hl(e){return e.type===`box`&&e.halfExtents!==void 0}function Ul(e){return e.type===`boundary`&&e.halfExtents!==void 0}var Wl=class{colliders=[];playerRadius;constructor(e=.72){this.playerRadius=e}setPlayerRadius(e){this.playerRadius=e}add(e){this.colliders.push(e)}addCircle(e,t,n,r=!0){this.colliders.push({type:`circle`,center:e.clone(),radius:t,label:n,isStatic:r})}addBox(e,t,n,r=!0){this.colliders.push({type:`box`,center:e.clone(),halfExtents:t.clone(),label:n,isStatic:r})}addBoundary(e,t,n){this.colliders.push({type:`boundary`,center:e.clone(),halfExtents:t.clone(),label:n,isStatic:!0})}clear(){this.colliders=[]}getAll(){return[...this.colliders]}getByLabel(e){return this.colliders.find(t=>t.label===e)}removeByLabel(e){let t=this.colliders.findIndex(t=>t.label===e);return t>=0?(this.colliders.splice(t,1),!0):!1}checkCollision(e){for(let t of this.colliders)if(Vl(t)){let n=e.x-t.center.x,r=e.z-t.center.z;if((Math.hypot(n,r)||1e-4)<t.radius+this.playerRadius)return t}else if(Hl(t)){let n=t.halfExtents.x+this.playerRadius,r=t.halfExtents.z+this.playerRadius;if(Math.abs(e.x-t.center.x)<n&&Math.abs(e.z-t.center.z)<r)return t}else if(Ul(t)){let n=t.halfExtents.x,r=t.halfExtents.z;if(e.x<t.center.x-n||e.x>t.center.x+n||e.z<t.center.z-r||e.z>t.center.z+r)return t}return null}resolveCollisions(e,t){let n=e.clone(),r=t,i=0;for(;i<3;){let e=!1;for(let t of this.colliders)if(Vl(t)){let i=n.x-t.center.x,a=n.z-t.center.z,o=Math.hypot(i,a)||1e-4,s=t.radius+this.playerRadius;if(o<s){let t=s-o;n.x+=i/o*t,n.z+=a/o*t,r*=.35,e=!0}}else if(Hl(t)){let i=t.halfExtents.x+this.playerRadius,a=t.halfExtents.z+this.playerRadius,o=n.x-t.center.x,s=n.z-t.center.z;if(Math.abs(o)<i&&Math.abs(s)<a){let t=i-Math.abs(o),c=a-Math.abs(s);t<c?n.x+=o>=0?t:-t:n.z+=s>=0?c:-c,r*=.4,e=!0}}else if(Ul(t)){let i=t.halfExtents.x,a=t.halfExtents.z,o=!1;n.x<t.center.x-i+this.playerRadius?(n.x=t.center.x-i+this.playerRadius,o=!0):n.x>t.center.x+i-this.playerRadius&&(n.x=t.center.x+i-this.playerRadius,o=!0),n.z<t.center.z-a+this.playerRadius?(n.z=t.center.z-a+this.playerRadius,o=!0):n.z>t.center.z+a-this.playerRadius&&(n.z=t.center.z+a-this.playerRadius,o=!0),o&&(r*=.5,e=!0)}if(!e)break;i++}return{position:n,speed:r}}debugDraw(e){let t=new wn,n=new ta(.05,.06,16),r=new Y(1,.02,1),i=new ri({color:4521796,side:2,transparent:!0,opacity:.3});for(let e of this.colliders)if(Vl(e)){let r=new J(n,i);r.position.set(e.center.x,.1,e.center.z),r.rotation.x=-Math.PI/2,r.scale.setScalar(e.radius*2),t.add(r)}else if(Hl(e)){let n=new J(r,i);n.position.set(e.center.x,.1,e.center.z),n.scale.set(e.halfExtents.x*2,1,e.halfExtents.z*2),t.add(n)}else if(Ul(e)){let n=new Ri(new Qi(new Y(e.halfExtents.x*2,.1,e.halfExtents.z*2)),new Ei({color:16776960,transparent:!0,opacity:.5}));n.position.set(e.center.x,.05,e.center.z),t.add(n)}return t}};Rl();var{canvas:Gl,scoreElement:Kl,currentZoneElement:ql,playerLabel:Jl,orbsElement:Yl,lessonCard:Xl,quizModal:Zl,quizZone:Ql,quizQuestion:$l,quizChoices:eu,quizFeedback:tu,quizSource:nu,continueButton:ru,winCard:iu,playAgainButton:au,startScreen:ou,startGameButton:su,playerNameInput:cu,audioToggle:lu,joystick:uu,joystickKnob:du,touchBrake:fu,touchReset:pu}=zl(),$=new Nn;$.background=new q(12576767),$.fog=new Mn(12576767,35,85),new Ia().load(`./assets/kampung-iman-skybox.png`,e=>{e.colorSpace=Le,$.background=e});function mu(t,n){let r=document.createElement(`canvas`);r.width=t,r.height=t,n(r.getContext(`2d`),t);let i=new Bi(r);return i.colorSpace=Le,i.wrapS=e,i.wrapT=e,i.needsUpdate=!0,i}function hu(t,n,r){let i=t.clone();return i.wrapS=e,i.wrapT=e,i.repeat.set(n,r),i.needsUpdate=!0,i}var gu=mu(256,(e,t)=>{let n=e.createLinearGradient(0,0,t,t);n.addColorStop(0,`#8fca6b`),n.addColorStop(1,`#5fa25d`),e.fillStyle=n,e.fillRect(0,0,t,t);for(let n=0;n<120;n+=1){let r=n*37%t,i=n*71%t;e.strokeStyle=n%3==0?`rgba(255,237,158,0.18)`:`rgba(27,91,52,0.18)`,e.lineWidth=1+n%2,e.beginPath(),e.moveTo(r,i),e.lineTo(r+8,i-13),e.stroke()}}),_u=mu(256,(e,t)=>{e.fillStyle=`#665a4b`,e.fillRect(0,0,t,t);for(let n=0;n<t;n+=34)for(let r=0;r<t;r+=52)e.fillStyle=(r+n)%3?`rgba(255,244,214,0.08)`:`rgba(35,27,20,0.10)`,e.fillRect(r+n/34%2*18,n,42,22);e.strokeStyle=`rgba(255,251,226,0.12)`,e.lineWidth=2;for(let n=0;n<t;n+=34)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke()}),vu=mu(256,(e,t)=>{e.fillStyle=`#e8c27c`,e.fillRect(0,0,t,t);for(let n=0;n<180;n+=1)e.fillStyle=n%2?`rgba(255,255,255,0.12)`:`rgba(119,71,38,0.10)`,e.beginPath(),e.arc(n*47%t,n*83%t,1+n%4,0,Math.PI*2),e.fill()}),yu=mu(256,(e,t)=>{e.fillStyle=`#6b3f30`,e.fillRect(0,0,t,t);for(let n=0;n<t;n+=28)for(let r=-20;r<t;r+=40)e.fillStyle=`rgba(255,209,102,0.12)`,e.beginPath(),e.ellipse(r+n/28%2*20,n,24,11,0,0,Math.PI),e.fill()}),bu=mu(256,(e,t)=>{e.fillStyle=`#8b5a2b`,e.fillRect(0,0,t,t);for(let n=0;n<t;n+=18)e.strokeStyle=n%36?`rgba(255,222,154,0.18)`:`rgba(54,31,18,0.18)`,e.lineWidth=2,e.beginPath(),e.moveTo(n,0),e.bezierCurveTo(n+12,80,n-12,160,n+8,t),e.stroke()}),xu=mu(128,(e,t)=>{e.fillStyle=`#2f8f46`,e.fillRect(0,0,t,t);for(let n=0;n<60;n+=1)e.strokeStyle=n%2?`rgba(180,240,150,0.24)`:`rgba(8,72,38,0.2)`,e.beginPath(),e.moveTo(n*29%t,n*17%t),e.lineTo(n*29%t+16,n*17%t-9),e.stroke()}),Su=mu(128,(e,t)=>{let n=e.createLinearGradient(0,0,t,t);n.addColorStop(0,`#ff7058`),n.addColorStop(.5,`#d84b38`),n.addColorStop(1,`#9d2f25`),e.fillStyle=n,e.fillRect(0,0,t,t),e.fillStyle=`rgba(255,255,255,0.16)`,e.fillRect(0,18,t,10)}),Cu=new Xa(55,window.innerWidth/window.innerHeight,.1,160),wu=new Fl({canvas:Gl,antialias:!0,alpha:!1,preserveDrawingBuffer:!0});wu.setPixelRatio(Math.min(window.devicePixelRatio,2)),wu.setSize(window.innerWidth,window.innerHeight),wu.setClearColor(12576767,1),wu.shadowMap.enabled=!0,wu.shadowMap.type=2;var Tu=new Ra(16777215,8019771,1.8);$.add(Tu);var Eu=new $a(16774358,2.2);Eu.position.set(16,22,10),Eu.castShadow=!0,Eu.shadow.mapSize.set(2048,2048),Eu.shadow.camera.left=-35,Eu.shadow.camera.right=35,Eu.shadow.camera.top=35,Eu.shadow.camera.bottom=-35,$.add(Eu);var Du=new J(new Y(70,.4,70),new X({color:9423467,map:hu(gu,18,18),roughness:.95}));Du.receiveShadow=!0,Du.position.y=-.22,$.add(Du);var Ou=new X({color:6707787,map:hu(_u,2,12),roughness:.88}),ku=new J(new Y(7,.05,52),Ou);ku.position.set(0,.03,0),ku.receiveShadow=!0,$.add(ku);var Au=new J(new Y(36,.052,6),Ou);Au.position.set(0,.04,-5),Au.receiveShadow=!0,$.add(Au),yd(-7.6,-5,12,3.2,.08),yd(0,8.2,3.3,14,-.05),yd(7.8,-5,12,3.2,-.08);for(let e=-24;e<=24;e+=4){let t=new J(new Y(.32,.065,1.7),new X({color:16774358,roughness:.7}));t.position.set(0,.085,e),t.receiveShadow=!0,$.add(t)}for(let e=-15;e<=15;e+=4){let t=new J(new Y(1.6,.066,.3),new X({color:16774358,roughness:.7}));t.position.set(e,.09,-5),t.receiveShadow=!0,$.add(t)}var ju=new wn,Mu=new J(new Gi(.62,.74,1.45,16),new X({color:2846442,map:hu(vu,1,1),roughness:.72}));Mu.position.y=.95,Mu.castShadow=!0,ju.add(Mu);var Nu=new J(new na(.38,18,12),new X({color:14262381,roughness:.78}));Nu.position.set(0,1.85,0),Nu.castShadow=!0,ju.add(Nu);var Pu=new J(new Ki(.55,.92,18),new X({color:16765286,roughness:.76}));Pu.position.set(0,1.72,-.03),Pu.castShadow=!0,ju.add(Pu);var Fu=new J(new Gi(.39,.39,.18,18),new X({color:16777215,roughness:.66}));Fu.position.set(0,2.15,0),Fu.castShadow=!0,Fu.visible=!1,ju.add(Fu);var Iu=new J(new Y(.46,.72,.18),new X({color:1331774,map:hu(Su,1,1),roughness:.72}));Iu.position.set(0,1.08,-.63),Iu.castShadow=!0,ju.add(Iu);var Lu=new J(new Gi(.12,.14,.62,10),new X({color:1909811,roughness:.82})),Ru=Lu.clone();Lu.position.set(-.24,.32,0),Ru.position.set(.24,.32,0),Lu.castShadow=Ru.castShadow=!0,ju.add(Lu,Ru);var zu=new J(new Gi(.08,.09,.78,10),new X({color:14262381,roughness:.78})),Bu=zu.clone();zu.position.set(-.68,1.08,.05),Bu.position.set(.68,1.08,.05),zu.rotation.z=.28,Bu.rotation.z=-.28,zu.castShadow=Bu.castShadow=!0,ju.add(zu,Bu);var Vu=new J(new Wi(.95,32),new ri({color:1522224,transparent:!0,opacity:.18}));Vu.rotation.x=-Math.PI/2,Vu.position.y=.015,ju.add(Vu);var Hu=[];ju.position.set(0,0,0),$.add(ju);var Uu=`girl`,Wu=`Aisyah`,Gu=!1;function Ku(e){Uu=e;let t=Mu.material;e===`girl`?(t.color.setHex(8085462),Pu.visible=!0,Fu.visible=!1,cu.value=cu.value||`Aisyah`):(t.color.setHex(2846442),Pu.visible=!1,Fu.visible=!0,cu.value=cu.value||`Raihan`)}var qu=new Wl(.72);function Ju(e,t,n){qu.addCircle(e,t,n)}function Yu(e,t,n){qu.addBox(e,t,n)}function Xu(e,t,n){qu.addBoundary(e,t,n)}function Zu(e,t,n=1){let r=new J(new Gi(.15*n,.22*n,1.2*n,5),new X({color:9132587,map:hu(bu,1,3),roughness:.82}));r.position.set(e,.6*n,t),r.castShadow=!0,$.add(r),Ju(new W(e,0,t),.62*n,`tree`);let i=new J(new Ki(.9*n,1.7*n,6),new X({color:3116870,map:hu(xu,1,1),roughness:.84}));i.position.set(e,1.85*n,t),i.castShadow=!0,$.add(i)}function Qu(e,t){let n=document.createElement(`canvas`);n.width=512,n.height=128;let r=n.getContext(`2d`);r.fillStyle=`rgba(255,251,226,0.92)`,r.strokeStyle=t,r.lineWidth=10,r.roundRect(16,18,480,92,28),r.fill(),r.stroke(),r.fillStyle=`#173a30`,r.font=`800 42px Inter, Arial, sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(e,256,64);let i=new qr(new Nr({map:new Bi(n),transparent:!0}));return i.scale.set(5.6,1.4,1),i}function $u(e,t,n=0){let r=new J(new Y(4.5,.35,3),new X({color:12158549,roughness:.75}));r.position.set(e,.15,t),r.rotation.set(-.16,n,0),r.castShadow=!0,r.receiveShadow=!0,$.add(r),Ju(new W(e,0,t),2.5,`ramp`)}var ed=[],td=new X({color:16769162,emissive:15771177,emissiveIntensity:.9});function nd(e,t){for(let n=0;n<22;n+=1){let r=new J(new $i(.08,0),td.clone());r.material.color.setHex(t),r.material.emissive.setHex(t),r.position.copy(e);let i=n/22*Math.PI*2;ed.push({mesh:r,velocity:new W(Math.cos(i)*(1.2+Math.random()),1.6+Math.random()*1.2,Math.sin(i)*(1.2+Math.random())),life:.8,maxLife:.8}),$.add(r)}}function rd(e,t,n,r,i=14266479){for(let a=0;a<n;a+=1){let o=new J(new Y(.16,.8,.16),new X({color:i,roughness:.8}));if(o.position.set(e+a*r,.4,t),o.castShadow=!0,$.add(o),a<n-1){let n=new J(new Y(r,.12,.12),new X({color:i,roughness:.8}));n.position.set(e+a*r+r/2,.62,t),n.castShadow=!0,$.add(n)}}}function id(e,t,n,r=0){let i=new wn,a=new X({color:n,map:hu(vu,1,2),roughness:.74}),o=new J(new Y(.45,2.5,.45),a);o.position.set(-1.35,1.25,0);let s=o.clone();s.position.x=1.35;let c=new J(new Y(3.15,.42,.5),a);c.position.y=2.55;let l=new J(new na(1.15,18,8,0,Math.PI*2,0,Math.PI/2),a);l.position.y=2.72,i.add(o,s,c,l),i.position.set(e,0,t),i.rotation.y=r,i.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(i),Ju(new W(e,0,t),1.7,`arch gate`)}function ad(e,t,n=16765286){let r=new J(new Gi(.05,.07,2.1,8),new X({color:5978926}));r.position.set(e,1.05,t);let i=new J(new Y(.42,.42,.42),new X({color:n,emissive:n,emissiveIntensity:.75,roughness:.4}));i.position.set(e,2.26,t),r.castShadow=!0,i.castShadow=!0,$.add(r,i)}function od(e,t){[2846442,16765286,2269291,14175032].forEach((n,r)=>{let i=new J(new Y(.8,.16,.52),new X({color:n,roughness:.65}));i.position.set(e,.15+r*.17,t),i.rotation.y=(r-1.5)*.16,i.castShadow=!0,$.add(i)})}function sd(e,t){let n=new J(new Y(1.1,.34,.62),new X({color:10183226,roughness:.75}));n.position.set(e,.2,t);let r=new J(new Ki(.42,.9,6),new X({color:3116870,roughness:.82}));r.position.set(e,.83,t),n.castShadow=!0,r.castShadow=!0,$.add(n,r),Ju(new W(e,0,t),.85,`planter`)}function cd(e,t){let n=new J(new Gi(1.15,1.25,.36,24),new X({color:14083037,roughness:.62}));n.position.set(e,.18,t);let r=new J(new Gi(.96,.96,.05,24),new X({color:8837119,transparent:!0,opacity:.72,roughness:.12}));r.position.set(e,.4,t);let i=new J(new Gi(.08,.12,1.2,12),new X({color:8837119,emissive:2846442,emissiveIntensity:.35,transparent:!0,opacity:.65}));i.position.set(e,1,t),n.castShadow=!0,$.add(n,r,i),Ju(new W(e,0,t),1.35,`fountain`)}function ld(e,t,n){let r=new wn,i=new J(new Y(2.4,1.35,2),new X({color:n,map:hu(vu,1,1),roughness:.78}));i.position.y=.68;let a=new J(new Ki(1.75,.95,4),new X({color:9194289,map:hu(yu,1,1),roughness:.85}));a.position.y=1.72,a.rotation.y=Math.PI/4,r.add(i,a),r.position.set(e,0,t),r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Yu(new W(e,0,t),new W(1.2,0,1),`house`)}function ud(e,t,n=0){let r=new wn,i=new X({color:10183226,map:hu(bu,1,1),roughness:.78}),a=new J(new Y(1.55,.18,.42),i);a.position.y=.48;let o=new J(new Y(1.55,.16,.36),i);o.position.set(0,.82,-.28),o.rotation.x=-.16,[-.55,.55].forEach(e=>{let t=new J(new Gi(.055,.07,.48,8),i);t.position.set(e,.24,.12),r.add(t)}),r.add(a,o),r.position.set(e,0,t),r.rotation.y=n,r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Yu(new W(e,0,t),new W(.78,0,.21),`bench`)}function dd(e,t,n,r,i=0){let a=new wn,o=new J(new Gi(.06,.08,1.45,8),new X({color:9132587,map:hu(bu,1,2),roughness:.82}));o.position.y=.72;let s=new J(new Y(1.45,.5,.12),new X({color:16776159,roughness:.66}));s.position.y=1.34;let c=Qu(n,`#${r.toString(16).padStart(6,`0`)}`);c.position.set(0,1.78,.08),c.scale.set(1.65,.42,1),a.add(o,s,c),a.position.set(e,0,t),a.rotation.y=i,a.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(a),Ju(new W(e,0,t),.42,`signpost`)}function fd(e,t,n=16765286){let r=new wn,i=new J(new Gi(.86,.98,.18,18),new X({color:9132587,roughness:.84}));i.position.y=.1,r.add(i);for(let e=0;e<7;e+=1){let t=e/7*Math.PI*2,i=new J(new Gi(.018,.025,.38,6),new X({color:3116870,roughness:.8}));i.position.set(Math.cos(t)*.42,.32,Math.sin(t)*.32);let a=new J(new na(.08,8,6),new X({color:e%2?n:15900856,roughness:.7}));a.position.set(i.position.x,.56,i.position.z),r.add(i,a)}r.position.set(e,0,t),r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Ju(new W(e,0,t),.85,`flower bed`)}function pd(e,t,n=0){let r=new wn,i=new J(new Y(1.9,1.15,.12),new X({color:9132587,map:hu(bu,1,1),roughness:.8}));i.position.y=1.15;let a=new J(new Y(1.68,.9,.13),new X({color:1331774,roughness:.92}));a.position.set(0,1.16,.02),[-.7,.7].forEach(e=>{let t=new J(new Gi(.045,.06,.9,8),new X({color:9132587,roughness:.8}));t.position.set(e,.42,0),r.add(t)}),r.add(i,a),r.position.set(e,0,t),r.rotation.y=n,r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Yu(new W(e,0,t),new W(.95,0,.06),`chalkboard`)}function md(e,t,n=0){let r=new wn,i=new X({color:10183226,map:hu(bu,1,1),roughness:.8}),a=new J(new Y(2.15,.62,.9),i);a.position.y=.42;let o=new J(new Y(2.55,.18,1.28),new X({color:16765286,roughness:.72}));o.position.y=1.72,[-.9,.9].forEach(e=>{let t=new J(new Gi(.04,.055,1.5,8),i);t.position.set(e,.95,-.32),r.add(t)});for(let e=0;e<4;e+=1){let t=new J(new na(.12,10,8),new X({color:e%2?15771177:9423467,roughness:.65}));t.position.set(-.62+e*.42,.86,.03),r.add(t)}r.add(a,o),r.position.set(e,0,t),r.rotation.y=n,r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Yu(new W(e,0,t),new W(1.28,0,.64),`market stall`)}function hd(e,t){let n=new wn,r=new J(new Y(.78,.62,.68),new X({color:3112284,roughness:.72}));r.position.y=.36;let i=new J(new Y(.86,.1,.76),new X({color:16765286,roughness:.64}));i.position.y=.72,n.add(r,i),n.position.set(e,0,t),n.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(n),Yu(new W(e,0,t),new W(.5,0,.35),`donation box`)}function gd(e,t){let n=new wn,r=new J(new Gi(.34,.42,.8,14),new X({color:9358054,roughness:.46}));r.position.y=.44;let i=new J(new Gi(.16,.12,.28,12),new X({color:16776159,roughness:.5}));i.position.set(.42,.62,0),n.add(r,i),n.position.set(e,0,t),n.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(n),Ju(new W(e,0,t),.58,`water stand`)}function _d(e,t,n=0){let r=new wn,i=new J(new Y(1.3,.18,.48),new X({color:9132587,map:hu(bu,1,1),roughness:.82}));i.position.y=.22,[-.32,.28].forEach(e=>{let t=new J(new Y(.28,.06,.46),new X({color:5978926,roughness:.76}));t.position.set(e,.37,.02),r.add(t)}),r.add(i),r.position.set(e,0,t),r.rotation.y=n,r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r),Yu(new W(e,0,t),new W(.65,0,.24),`sandal rack`)}function vd(e,t,n=0){let r=new wn,i=new J(new Gi(.025,.035,1.2,8),new X({color:9132587,roughness:.8}));i.position.y=.75,i.rotation.z=.32;let a=new J(new Ki(.22,.42,8),new X({color:14266479,roughness:.86}));a.position.set(.2,.18,0),a.rotation.z=.32,r.add(i,a),r.position.set(e,0,t),r.rotation.y=n,r.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),$.add(r)}function yd(e,t,n,r,i=0){let a=new J(new Y(n,.035,r),new X({color:14266479,map:hu(_u,Math.max(1,n/5),Math.max(1,r/5)),roughness:.9}));a.position.set(e,.075,t),a.rotation.y=i,a.receiveShadow=!0,$.add(a)}function bd(e,t){let n=new J(new Gi(7.2,7.8,.05,48),new X({color:t,transparent:!0,opacity:.18,roughness:.86}));n.position.set(e.x,.065,e.z),n.receiveShadow=!0,$.add(n)}function xd(e,t,n){bd(t,n),id(t.x,t.z+6.3,n,Math.PI),ad(t.x-4.6,t.z+4.4,n),ad(t.x+4.6,t.z+4.4,n),dd(t.x-3.6,t.z+5.2,e===`adab`?`Kindness`:e===`ilmu`?`Learn`:`Help`,n,-.2),e===`adab`&&(cd(t.x-5.2,t.z-.6),rd(t.x-7,t.z-5.6,8,1.8,14266479),ud(t.x+3.6,t.z-2.6,-.5),_d(t.x+5.1,t.z+.2,.4),gd(t.x-1.9,t.z-4.3),vd(t.x+1.7,t.z+3.1,.8),fd(t.x-3,t.z+2.8,15900856)),e===`ilmu`&&(od(t.x-5.5,t.z+.4),od(t.x+5.1,t.z-1.8),od(t.x+3.2,t.z+4.6),pd(t.x-3.9,t.z-3.6,.25),ud(t.x+4.5,t.z+2.3,.45),fd(t.x-.5,t.z-5,9358054)),e===`sadaqah`&&([-5.4,-3.6,3.6,5.4].forEach(e=>sd(t.x+e,t.z+1.2)),rd(t.x-7.2,t.z-5.6,9,1.8,10183226),md(t.x-4.6,t.z-2.4,.35),hd(t.x+3.8,t.z-3.6),gd(t.x+5.5,t.z+3.5),fd(t.x+.5,t.z+4.6,16765286))}function Sd(e,t,n){let r=new wn,i=new J(new Y(5.4,2.2,4.6),new X({color:t,map:hu(vu,2,1),roughness:.76}));i.position.y=1.1,i.castShadow=!0,r.add(i);let a=new J(new Ki(3.8,1.4,4),new X({color:5978926,map:hu(yu,2,2),roughness:.86}));a.position.y=2.9,a.rotation.y=Math.PI/4,a.castShadow=!0,r.add(a);let o=new J(new Y(4.2,.18,.35),new X({color:16776159,roughness:.6}));o.position.set(0,2.05,2.48),r.add(o);let s=Qu(n,`#${t.toString(16).padStart(6,`0`)}`);s.position.set(0,4.05,2.35),r.add(s),r.position.copy(e),r.userData.label=n,$.add(r),Yu(e,new W(2.7,0,2.3),n)}function Cd(e,t,n){let r=Bl[e].color,i=new wn;i.position.copy(n);let a=new J(new Gi(.98,1.12,.18,28),new X({color:r,transparent:!0,opacity:.78,emissive:r,emissiveIntensity:.12,roughness:.65}));a.position.y=.12;let o=new J(new Gi(.22,.28,.82,14),new X({color:e===`sadaqah`?15771177:e===`ilmu`?2846442:2269291,roughness:.75}));o.position.set(-.34,.72,0);let s=new J(new na(.18,14,10),new X({color:14262381,roughness:.8}));s.position.set(-.34,1.24,0);let c=new wn;if(e===`ilmu`){let e=new J(new Y(.7,.12,.46),new X({color:16765286,roughness:.58}));e.position.set(.32,.48,0),c.add(e)}else if(e===`sadaqah`){let e=new J(new Y(.62,.38,.42),new X({color:10183226,map:hu(bu,1,1),roughness:.8}));e.position.set(.34,.45,0);let t=new J(new na(.14,12,8),new X({color:16765286,roughness:.62}));t.position.set(.24,.76,.08),c.add(e,t)}else{let e=new J(new ra(.34,.035,10,24),new X({color:16765286,emissive:2269291,emissiveIntensity:.35}));e.position.set(.34,.82,0),c.add(e)}let l=new J(new ra(1.12,.035,8,48),new X({color:16774051,emissive:r,emissiveIntensity:.55}));l.rotation.x=Math.PI/2,l.position.y=.18;let u=Qu(e===`adab`?`Kindness`:e===`ilmu`?`Learn`:`Help`,`#${r.toString(16).padStart(6,`0`)}`);return u.position.set(0,1.95,0),u.scale.set(2.4,.62,1),i.add(a,o,s,c,l,u),i.traverse(e=>{e instanceof J&&(e.castShadow=!0)}),i.userData.title=t.question,i}var wd=[];Object.entries(Bl).forEach(([e,t])=>{Sd(t.position,t.color,t.title),xd(e,t.position,t.color);let n=new J(new Gi(4.8,4.8,.08,48),new X({color:t.color,transparent:!0,opacity:.22}));n.position.set(t.position.x,.08,t.position.z),$.add(n),Il[e].forEach((n,r,i)=>{let a=r/i.length*Math.PI*2+(e===`ilmu`?Math.PI/2:0),o=e===`ilmu`?4.4:3.7,s=Cd(e,n,new W(t.position.x+Math.cos(a)*o,0,t.position.z+Math.sin(a)*o));$.add(s),wd.push({mesh:s,zone:e,quiz:n,collected:!1})})}),$u(-5,-18,.35),$u(7,18,-.25),$u(18,4,1.35),[[-22,-20,14266479],[-18,14,15312491],[20,-18,16765286],[23,15,12704163],[-25,4,15909536],[25,-2,10208984],[-12,-24,13227956],[12,23,16043936]].forEach(([e,t,n])=>ld(e,t,n)),dd(0,-11,`Village Path`,3112284,0),ud(-3.8,-9.4,.35),ud(4.1,-9.2,-.35),fd(-6.6,-8.6,15900856),fd(6.8,-8.4,16765286),Xu(new W(0,0,0),new W(31,0,31),`world boundary`);for(let e=0;e<42;e+=1){let e=(Math.random()-.5)*62,t=(Math.random()-.5)*62;Math.abs(e)<6||Math.abs(t+5)<5||Zu(e,t,.75+Math.random()*.55)}var Td=new Set,Ed=0,Dd=0,Od=0,kd=null,Ad=!1,jd=!1,Md=null,Nd=0,Pd=new _o,Fd=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;window.addEventListener(`keydown`,e=>{Td.add(e.key.toLowerCase()),e.key.toLowerCase()===`r`&&zd()}),window.addEventListener(`keyup`,e=>Td.delete(e.key.toLowerCase())),window.addEventListener(`resize`,Bd);var Id={throttle:0,steer:0,brake:!1,activePointerId:-1};function Ld(e){let t=uu.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2,i=t.width*.34,a=Et.clamp(e.clientX-n,-i,i),o=Et.clamp(e.clientY-r,-i,i);Id.steer=Et.clamp(a/i,-1,1),Id.throttle=Et.clamp(-o/i,-1,1),du.style.transform=`translate(${a}px, ${o}px)`}uu.addEventListener(`pointerdown`,e=>{e.preventDefault(),Id.activePointerId=e.pointerId,uu.setPointerCapture(e.pointerId),Ld(e)}),uu.addEventListener(`pointermove`,e=>{e.pointerId===Id.activePointerId&&Ld(e)});function Rd(e){e&&e.pointerId!==Id.activePointerId||(Id.activePointerId=-1,Id.throttle=0,Id.steer=0,du.style.transform=`translate(0, 0)`)}uu.addEventListener(`pointerup`,Rd),uu.addEventListener(`pointercancel`,Rd),fu.addEventListener(`pointerdown`,e=>{e.preventDefault(),Id.brake=!0}),fu.addEventListener(`pointerup`,()=>{Id.brake=!1}),fu.addEventListener(`pointercancel`,()=>{Id.brake=!1}),pu.addEventListener(`click`,zd);function zd(){ju.position.set(0,0,0),ju.rotation.set(0,0,0),Ed=0,Mu.rotation.set(0,0,0),Nu.rotation.set(0,0,0),zu.rotation.x=0,Bu.rotation.x=0}function Bd(){Cu.aspect=window.innerWidth/window.innerHeight,Cu.updateProjectionMatrix(),wu.setSize(window.innerWidth,window.innerHeight)}function Vd(e){if(!Gu||Ad)return;let t=Td.has(`w`)||Td.has(`arrowup`)||Id.throttle>.16,n=Td.has(`s`)||Td.has(`arrowdown`)||Id.throttle<-.28,r=Td.has(`a`)||Td.has(`arrowleft`),i=Td.has(`d`)||Td.has(`arrowright`),a=Td.has(` `)||Id.brake,o=(Math.abs(Id.throttle)>.16?Id.throttle*10:0)||(t?10:n?-7:0);Ed+=o*e,Ed*=a?.84:.975,Ed=Et.clamp(Ed,-8,13),Hu.forEach(t=>{t.rotation.x+=Ed*e*2.4});let s=+!!r+(i?-1:0),c=Math.abs(Id.steer)>.08?-Id.steer:s,l=Et.clamp(Math.abs(Ed)/7,.2,1);ju.rotation.y+=c*l*e*2.5*Math.sign(Ed||1),Mu.rotation.z=Et.lerp(Mu.rotation.z,c*.1*l,.12),Nu.rotation.z=Et.lerp(Nu.rotation.z,c*.07*l,.12),Mu.position.y=.95+Math.sin(Pd.elapsedTime*9)*Math.min(Math.abs(Ed)/40,.08);let u=new W(Math.sin(ju.rotation.y),0,Math.cos(ju.rotation.y));ju.position.addScaledVector(u,Ed*e);let d=qu.resolveCollisions(ju.position,Ed);ju.position.copy(d.position),Ed=d.speed,Lu.rotation.x=Math.sin(Pd.elapsedTime*9)*Math.min(Math.abs(Ed)/16,.55),Ru.rotation.x=-Lu.rotation.x,zu.rotation.x=-Lu.rotation.x*.55,Bu.rotation.x=Lu.rotation.x*.55;let f=Object.values(Bl).find(e=>ju.position.distanceTo(e.position)<6.5);ql.textContent=f?f.title.replace(` Courtyard`,``).replace(` Library`,``).replace(` Garden`,``):`Village`,Xl.textContent=f?`${f.title}: ${Bl[Object.keys(Bl).find(e=>Bl[e]===f)].lesson}`:`Walk to activity circles. Each scene opens a short quest and a wisdom point.`}function Hd(e){let t=window.innerWidth<720,n=new W(Math.sin(ju.rotation.y),0,Math.cos(ju.rotation.y)).multiplyScalar(t?-10:-8),r=ju.position.clone().add(n).add(new W(0,t?6.2:5.2,0));Cu.position.lerp(r,1-.001**e),Cu.lookAt(ju.position.x,ju.position.y+1.1,ju.position.z)}function Ud(){Ad||wd.forEach(e=>{e.collected||e.mesh.position.distanceTo(ju.position)<1.9&&Wd(e)})}function Wd(e){kd=e,Ad=!0,Ed=0,Ql.textContent=`${Bl[e.zone].title} · Activity with ${Wu}`,$l.textContent=e.quiz.question,tu.textContent=``,nu.textContent=`Source: ${e.quiz.source}`,ru.disabled=!0,eu.innerHTML=``,e.quiz.choices.forEach((e,t)=>{let n=document.createElement(`button`);n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>Gd(t)),eu.append(n)}),Zl.classList.remove(`answered-correct`,`answered-wrong`),Zl.showModal(),eu.querySelector(`button`)?.focus()}function Gd(e){if(!kd)return;let t=e===kd.quiz.answer;Dd+=t?100:25,Od+=1,kd.collected=!0,kd.mesh.visible=!1,nd(kd.mesh.position,Bl[kd.zone].color),Jd(),tu.textContent=`${t?`Correct!`:`Good try.`} ${kd.quiz.explanation}`,tu.className=t?`feedback correct`:`feedback wrong`,Zl.classList.toggle(`answered-correct`,t),Zl.classList.toggle(`answered-wrong`,!t),Array.from(eu.children).forEach((e,t)=>{let n=e;n.disabled=!0,t===kd?.quiz.answer&&n.classList.add(`right-answer`)}),Kl.textContent=String(Dd),Kl.classList.remove(`score-bump`),Kl.offsetWidth,Kl.classList.add(`score-bump`),Yl.textContent=`${Od}/${wd.length}`,Od>=wd.length&&(jd=!0,iu.hidden=!1),ru.disabled=!1}ru.addEventListener(`click`,()=>{Ad=jd,kd=null}),document.querySelectorAll(`.character-pick`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.character-pick`).forEach(e=>{e.classList.remove(`selected`),e.setAttribute(`aria-pressed`,`false`)}),e.classList.add(`selected`),e.setAttribute(`aria-pressed`,`true`),document.querySelector(`#character-preview`)?.classList.toggle(`boy-selected`,e.dataset.character===`boy`),Ku(e.dataset.character||`girl`)})}),su.addEventListener(`click`,()=>{Wu=cu.value.trim()||(Uu===`girl`?`Aisyah`:`Raihan`),Jl.textContent=Wu,ou.hidden=!0,Gu=!0,Xl.textContent=`${Wu}, walk to an activity circle to begin your first quest.`,Kd()});function Kd(){Md||=new AudioContext,Md.state===`suspended`&&Md.resume(),lu.textContent=`Sound On`}lu.addEventListener(`click`,()=>{Md?Md.state===`running`?(Md.suspend(),lu.textContent=`Sound Off`):(Md.resume(),lu.textContent=`Sound On`):Kd()});function qd(e,t=.16,n=.045){if(!Md||Md.state!==`running`)return;let r=Md.createOscillator(),i=Md.createGain();r.type=`sine`,r.frequency.value=e,i.gain.setValueAtTime(0,Md.currentTime),i.gain.linearRampToValueAtTime(n,Md.currentTime+.02),i.gain.exponentialRampToValueAtTime(1e-4,Md.currentTime+t),r.connect(i).connect(Md.destination),r.start(),r.stop(Md.currentTime+t)}function Jd(){qd(660,.12,.05),window.setTimeout(()=>qd(880,.16,.04),90)}function Yd(e){if(!(!Md||Md.state!==`running`||!Gu||Ad)&&(Nd-=e,Nd<=0)){let e=[392,440,494,587,494,440];qd(e[Math.floor(Pd.elapsedTime*1.4)%e.length],.28,.018),Nd=.58}}Ku(`girl`),au.addEventListener(`click`,()=>{wd.forEach(e=>{e.collected=!1,e.mesh.visible=!0}),Dd=0,Od=0,jd=!1,Ad=!1,kd=null,Kl.textContent=`0`,Yl.textContent=`0/${wd.length}`,iu.hidden=!0,zd()});function Xd(){let e=Math.min(Pd.getDelta(),.033);Vd(e),Yd(e),wd.forEach((t,n)=>{if(t.collected)return;Fd||(t.mesh.rotation.y+=e*.45);let r=t.mesh.position.distanceTo(ju.position)<5,i=Fd?1:1+Math.sin(Pd.elapsedTime*(r?5:2.5)+n)*(r?.11:.04);t.mesh.scale.setScalar(r?i*1.08:i),t.mesh.position.y=Fd?.8:.8+Math.sin(Pd.elapsedTime*1.8+n)*.1}),ed.forEach((t,n)=>{t.life-=e,t.velocity.y-=e*2.2,t.mesh.position.addScaledVector(t.velocity,e),t.mesh.scale.setScalar(Math.max(.05,t.life/t.maxLife)),t.life<=0&&($.remove(t.mesh),ed.splice(n,1))}),Ud(),Hd(e),wu.render($,Cu),requestAnimationFrame(Xd)}Bd(),zd(),Xd();